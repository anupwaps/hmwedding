                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group has-feedback">
                            ...
                            <input type="number" class="form-control form-control-sm height_mask" name="min_height" id="min_height"  min="4.0" max="7.0">
                            <div class="help-block with-errors">
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group has-feedback">
                            ...
                            <input type="number" class="form-control form-control-sm height_mask" name="max_height" id="max_height" min="4.0" max="7.0">
                        </div>
                        <div class="help-block with-errors">
                        </div>
                    </div>
