                ...
                <table class="table table-profile table-responsive table-striped table-bordered table-slick">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php 
                                // $dd = $this->db->get_where('sub_caste',array('sub_caste_id'=>$spiritual_and_social_background_data[0]['sub_caste']))->row()->sub_caste_name;
                                // var_dump($spiritual_and_social_background_data[0]['sub_caste']);
                                echo $this->db->get_where('sub_caste',array('sub_caste_id'=>1))->row()->sub_caste_name;
                                ?>
                            </td>
                            <td class="td-label">
